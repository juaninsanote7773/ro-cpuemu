...
local asm_script = {
	...
	"push 'a'", --misc, just testing stuff with the stack and calls
	"call printf"
}
...
RunService.Heartbeat:Connect(function(dt)
	...
	if PROGRAM_COUNTER > RAM.RAM_SIZE then
		PROGRAM_COUNTER = 1
	end

	cpu_tick(PROGRAM_COUNTER)
...
local compiled = ASM.compile(fizz_buzz)
PROCESS.start_comp(compiled)
